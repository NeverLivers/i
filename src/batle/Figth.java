...
public final class Figth {

    public Figth() {
    }
    private static Scanner scaner = new Scanner(System.in);
    private int number = scaner.nextInt();
    public static int random(int min, int max) {
        return (int) (min + Math.random() * (max - min));
    }
    private static final Figth BATLE;
    ...
    private Fighter[] oponents = new Fighter[]{new Warrior(), new Archer(), new Berserker(), new Rogue(), new Magician()};

    static {
        BATLE = new Figth();
    }

    public static Figth getBatle() {
        return BATLE;
    }
    ...
    public void start(){
        ...
        number = scaner.nextInt();
            ...
            if (number == 1) {
                ...
                Fighter oponentsForWarior = oponents[(int)(Math.random() * 4)];
                ...
                warrior.defence(oponentsForWarior.atack());
                oponentsForWarior.defence(warrior.atack());
            }
            if (warrior.getHealth() > 0){
                ...
                while (berserker.getHealth() > 0){
                    ...
                    Fighter oponentsForBerserker = oponents[(int)(Math.random() * 4)];
                    weapons = new Weapon[]{new MoonShadow(), new Cutter(), new Bloodsucker(), new Penetrator(),new Bones(), new AssasinDagger(),new Doomhammer(),new GorgonsEys(), new Atiesh(), new GlassSpice(), new BloodyHowl(), new HammerOfHeawen(), new DarckBlade(), new SwordOfFilth(), new Scourge()};
                    Weapon weaponForOponent = weapons[(int)(Math.random() * 14)];
                    berserker.defence(oponentsForBerserker.atack());
                    oponentsForBerserker.defence(berserker.atack());
                }
                ...
                while (rogue.getHealth() > 0){
                    ...
                    Fighter oponentsForRogue = oponents[(int)(Math.random() * 4)];
                    weapons = new Weapon[]{new MoonShadow(), new Cutter(), new Bloodsucker(), new Penetrator(),new Bones(), new AssasinDagger(),new Doomhammer(),new GorgonsEys(), new Atiesh(), new GlassSpice(), new BloodyHowl(), new HammerOfHeawen(), new DarckBlade(), new SwordOfFilth(), new Scourge()};
                    Weapon weaponForOponent = weapons[(int)(Math.random() * 14)];
                    rogue.defence(oponentsForRogue.atack());
                    oponentsForRogue.defence(rogue.atack());
                }
                ...
                while (magician.getHealth() > 0){
                    ...
                    Fighter oponentsForMagician = oponents[(int)(Math.random() * 4)];
                    weapons = new Weapon[]{new MoonShadow(), new Cutter(), new Bloodsucker(), new Penetrator(),new Bones(), new AssasinDagger(),new Doomhammer(),new GorgonsEys(), new Atiesh(), new GlassSpice(), new BloodyHowl(), new HammerOfHeawen(), new DarckBlade(), new SwordOfFilth(), new Scourge()};
                    Weapon weaponForOponent = weapons[(int)(Math.random() * 14)];
                    magician.defence(oponentsForMagician.atack());
                    oponentsForMagician.defence(magician.atack());
                }
                ...
                while (archer.getHealth() > 0){
                    ...
                    Fighter oponentsForArcher = oponents[(int)(Math.random() * 4)];
                    weapons = new Weapon[]{new MoonShadow(), new Cutter(), new Bloodsucker(), new Penetrator(),new Bones(), new AssasinDagger(),new Doomhammer(),new GorgonsEys(), new Atiesh(), new GlassSpice(), new BloodyHowl(), new HammerOfHeawen(), new DarckBlade(), new SwordOfFilth(), new Scourge()};
                    Weapon weaponForOponent = weapons[(int)(Math.random() * 14)];
                    archer.defence(oponentsForArcher.atack());
                    oponentsForArcher.defence(archer.atack());
                }
            ...
            System.out.println("atack" + warrior.atack());
